                    ...
                    <form id="payment-form" method="POST" action="">
                        <section>
                            ...
                            <fieldset class="mb-3 bg-white shadow-lg rounded text-gray-600">
                                ...
                                <label class="flex border-b border-gray-200 h-12 py-3 items-center">
                                    <span class="text-right px-2">Date</span>
                                    <input name="date" class="focus:outline-none px-3" placeholder="DD-MM-YYYY">
                                </label>
                                <label class="flex border-b border-gray-200 h-12 py-3 items-center">
                                    <span class="text-right px-2">Phone Number</span>
                                    <input name="city" class="focus:outline-none px-3" placeholder="08XXXXXXXXXX">
                                </label>
                            </fieldset>
                        </section>
                    </form>
                ...
                <ul class="py-6 border-b space-y-6 px-8">
                    <li class="grid grid-cols-6 gap-2 border-b-1">
                        <div class="col-span-1 self-center">
                            <img src="assets/img/meet.jpeg" alt="Product" class="rounded w-full">
                        </div>
                        ...
                        <div class="col-span-2 pt-3">
                            <div class="flex items-center space-x-2 text-sm justify-between">
                                ...
                                <span class="text-pink-400 font-semibold inline-block">Rp20.000</span>
                            </div>
                        </div>
                    </li>
                </ul>
